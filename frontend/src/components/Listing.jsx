...

            {
                listingData && !error && (
                    <div>
                        ...
                        <div className='flex flex-col w-[90vw] md:w-[60vw] mx-auto p-3 my-7 gap-4'>
                            ...
                            <div className='flex gap-4'>
                                <span className='bg-red-100 text-red-900 px-3 py-1 rounded-xl border border-red-200'>
                                    {listingData.type === 'rent' ? 'For Rent' : 'For Sale'}
                                </span>

                                {listingData.offer && (
                                    <span className='bg-green-200 text-green-900 px-3 py-1 rounded-xl border border-green-200'>
                            ...
                            <div className="bg-blck flex justify-center">
                                <button className='cursor-not-allowed hover:opacity-70 w-[100%] sm:w-[50%] mt-5 bg-green-700 text-white px-4 py-2 rounded-lg'>
                                    Contact Owner
                                </button>
                            </div>
                        </div>
